...
@app.task
def run_flake8_on_sandbox_on_code(solution_id: str, code: str):
    try:
        _logger.info('Start running sandbox check solution %s', solution_id)
        ...
        _logger.exception('Failed to check solution %s', solution_id)
